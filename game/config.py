...
BOSS_INFO = {
    '毁灭者': {
        'desc': '初代Boss，三阶段攻击模式，血量越低越狂暴。弱点会周期性暴露。',
        'phases': [
            '第一阶段（100%-75%）：常规弹幕攻击，移动缓慢，弱点未暴露',
            '第二阶段（75%-25%）：激光扫射+弹幕组合，开始周期性暴露弱点',
            '第三阶段（25%-0%）：狂暴模式，全屏幕弹幕，弱点暴露时间延长',
        ]
    },
    '虚空之眼': {
        'desc': '凝视你的深渊之眼，全屏幕弹幕攻击，找到间隙穿越。',
        'phases': [
            '第一阶段：8方向旋转弹幕，规律明显',
            '第二阶段：随机位置出现黑洞，吸引玩家+发射追踪弹',
            '第三阶段：死亡凝视+全屏爆弹，极限躲避考验',
        ]
    },
    '黑暗领主': {
        'desc': '拥有召唤能力的Boss，会持续召唤小怪助战，优先清理召唤物。',
        'phases': [
            '第一阶段：召唤自杀无人机掩护本体攻击',
            '第二阶段：召唤战斗机编队，本体发射扇形弹幕',
            '第三阶段：召唤精英母舰，释放全屏轰炸',
        ]
    },
    '湮灭者': {
        'desc': '全身武器化的战争机器，每阶段切换不同武器组。',
        'phases': [
            '第一阶段：左右机枪扫射，高速移动',
            '第二阶段：肩部导弹齐射+激光拦截网',
            '第三阶段：胸口巨炮充能+全武器齐射',
    ...
    '死神': {
        'desc': '最终Boss，拥有所有Boss的攻击模式集合，真正的死亡考验。',
        'phases': [
            '第一阶段：复刻毁灭者弹幕+虚空之眼旋转弹',
            '第二阶段：召唤黑暗领主小怪+湮灭者机枪',
            '第三阶段：所有模式混合，攻击无间隙，弱点极短',
        ]
    },
}
...
SHIP_CONFIGS_FILE = 'data/ship_configs.json'
